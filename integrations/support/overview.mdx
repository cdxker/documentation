...
description: "Integrate with a support component"
---
...
Integrate customer support components into your documentation. Add the `integrations` field to your `docs.json` file with your respective app ID.
