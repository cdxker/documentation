...
Use the `Update` widget to display changelog entries, version updates, and release notes with consistent formatting.
...
Use multiple `Update` widgets to create [changelogs](/guides/changelogs).
