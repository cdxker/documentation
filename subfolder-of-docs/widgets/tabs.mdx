---
title: "Tabs"
description: "Toggle content using the Tabs widget"
icon: "panel-top"
---

Use tabs to organize content into multiple panels that users can switch between. You can add any number of tabs and include other widgets inside each tab.

<Tabs>
  <Tab title="First tab">
    ☝️ Welcome to the content that you can only see inside the first tab.

    You can add any number of widgets inside of tabs. For example, a code block:
