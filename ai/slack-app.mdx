...
<Note>
  The Slack bot works with both public and private documentation. For organizations with authentication enabled, the bot can access and search all content that your organization has access to, regardless of authentication settings.
</Note>
