...
The Slack bot works with both public and private documentation. For authenticated documentation, the bot can access any content that your organization has configured for the Slack integration.
