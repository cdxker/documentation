...
The Slack bot works with both public and private documentation. For authenticated documentation, the bot can access any content that users in your organization have permission to view.
