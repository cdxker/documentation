...
<Note>
  External users (those outside your Slack workspace) may not be able to send direct messages to the bot. Have them @mention the bot in shared channels instead.
</Note>
