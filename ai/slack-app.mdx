...
The Slack app consumes [AI assistant credits](/guides/assistant#ai-assistant-credits) from your monthly allowance. Each interaction with the bot uses 1 credit:

- Direct message to `@mintlify` → 1 credit per response
- @mention in any channel → 1 credit per response  
- Question in `#ask-ai` channel → 1 credit per response

Monitor your Slack bot usage alongside your documentation assistant usage in your [dashboard](https://dashboard.mintlify.com/products/assistant) to track total credit consumption across all AI features.
