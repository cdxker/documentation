...
The AI assistant works with both public and private documentation. If your documentation uses authentication (whether full or partial), the assistant can access and search through all content that your organization has access to, including protected pages.
