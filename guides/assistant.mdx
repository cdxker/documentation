...
The assistant works with both public and private documentation. When your documentation uses authentication (whether full or partial), the assistant can access and search all content that your organization has access to, including protected pages. This allows the assistant to provide comprehensive answers based on your complete documentation set.

<Note>
  This is different from the [MCP server](/ai/model-context-protocol), which can only access publicly available documentation content.
</Note>
