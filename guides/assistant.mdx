...
The assistant works with both public and private documentation. For authenticated documentation, the assistant can access any content that the current user has permission to view.
