...
## Enabling thumbs up/down feedback

To enable the thumbs up/down voting feature on your documentation pages:

1. Navigate to the [Add-ons](https://dashboard.mintlify.com/products/addons) page in your dashboard
2. Enable the **Feedback** feature
3. Once enabled, thumbs up/down buttons will appear on your documentation pages
4. View feedback analytics in the **Feedback** tab of your analytics dashboard
